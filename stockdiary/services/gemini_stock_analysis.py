...
・財務データを評価の主軸とし、ニュースはあくまで補足情報として扱うこと。
・ニュースが財務評価と矛盾する場合は財務データを優先すること。
・ポジティブなニュース（好決算・新製品・提携等）は strengths に1〜2行で反映可。
・ネガティブなニュース（不祥事・業績悪化・規制等）は risks に1〜2行で反映可。
・ニュースがない場合やノイズと判断した場合は無視してよい。
