...
| 8b 想起ホーム | RecallService拡張（検証期日/的中/外れ）＋home想起化（損益除去） | 予定 |
| 8c ライブラリ | 学び/テーマ/仮説軸の検索（既存一覧を移送） | 予定 |
| 8d 投資家カルテ | 2×2分布・繰り返す失敗・哲学の変化（年間レビューを母体に） | 予定 |
| 8e 継続装置 | 検証期日Push・月次/年次レビュー・学び累積 | 予定 |
